<%-- 
    Document   : reportWeekly
    Created on : 9 Dec, 2017, 9:41:45 PM
    Author     : mzv
--%>
        ...
        <div class="container-fluid bg-2">
            ...
            <div class="container">          
                <table class="table bg-info">
                    <tbody>
                        <%  String sqlTotal = "SELECT sum(total),sum(totalProfit),count(id) FROM sales where date >= NOW() - INTERVAL 1 WEEK";
            ...
            <div class="container">          
                <table class="table bg-info">
                    ...
                    <tbody>
                        <%
                            String sqlGroupByDay = "select day(date),month(date),year(date) ,sum(total),sum(totalProfit),count(id) from sales where date >= NOW() - INTERVAL 1 WEEK group by day(date),month(date),year(date) ";
            ...
            <table class="table able-striped bg-3 ">
                ...
                <tbody>
                    <%
                        String sqlSales = "SELECT * FROM sales WHERE date >= NOW() - INTERVAL 1 WEEK";
